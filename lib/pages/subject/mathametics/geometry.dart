...
import 'package:sunamonir_pathshala/pages/subject/mathametics/geometry/diff_types_of_triangle.dart';
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const DiffAngleAndMeasure(),
                      ),
                    );
                  },
                  child: Container(
                ...
                GestureDetector(
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const DiffTypesOfTriangle(),
                      ),
                    );
                  },
                  child: Container(
