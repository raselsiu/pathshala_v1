...
class BorderArea extends StatelessWidget {
  const BorderArea({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: borderAreaData.length,
        itemBuilder: (context, index) {
          final item = borderAreaData[index];
          return Container(
