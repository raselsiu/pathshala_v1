...
class PlanetSolarUniverse extends StatelessWidget {
  const PlanetSolarUniverse({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.builder(
        ...
        itemCount: planetSolarUniverseData.length,
        itemBuilder: (context, index) {
          final item = planetSolarUniverseData[index];
          return Container(
