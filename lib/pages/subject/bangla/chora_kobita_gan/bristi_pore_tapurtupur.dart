...
class BristiPoreTapurTupur extends StatefulWidget {
  const BristiPoreTapurTupur({super.key});

  @override
  State<BristiPoreTapurTupur> createState() => _BristiPoreTapurTupurState();
}

class _BristiPoreTapurTupurState extends State<BristiPoreTapurTupur> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.bristiPoreTapurTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.bristiPoreTapurSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.bristiPoreTapurDesc,
