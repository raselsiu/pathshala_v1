...
class PalkirGan extends StatefulWidget {
  const PalkirGan({super.key});

  @override
  State<PalkirGan> createState() => _PalkirGanState();
}

class _PalkirGanState extends State<PalkirGan> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.palkirGanSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
