...
class KajerChele extends StatefulWidget {
  const KajerChele({super.key});

  @override
  State<KajerChele> createState() => _KajerCheleState();
}

class _KajerCheleState extends State<KajerChele> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.kajerCheleSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
