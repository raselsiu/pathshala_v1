...
class GadharKan extends StatefulWidget {
  const GadharKan({super.key});

  @override
  State<GadharKan> createState() => _GadharKanState();
}

class _GadharKanState extends State<GadharKan> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.gadharKanSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
