...
class NokshiKatharMathEight extends StatefulWidget {
  const NokshiKatharMathEight({super.key});

  @override
  State<NokshiKatharMathEight> createState() => _NokshiKatharMathEightState();
}

class _NokshiKatharMathEightState extends State<NokshiKatharMathEight> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.nokshiKatharMathEightTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.nokshiKatharMathEightSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.nokshiKatharMathEightDesc,
