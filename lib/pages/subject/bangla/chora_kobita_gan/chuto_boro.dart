...
class ChutoBoro extends StatefulWidget {
  const ChutoBoro({super.key});

  @override
  State<ChutoBoro> createState() => _ChutoBoroState();
}

class _ChutoBoroState extends State<ChutoBoro> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.chutoBoroSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
