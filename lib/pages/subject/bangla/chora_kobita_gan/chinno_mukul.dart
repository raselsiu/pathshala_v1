...
class ChinnoMukul extends StatefulWidget {
  const ChinnoMukul({super.key});

  @override
  State<ChinnoMukul> createState() => _ChinnoMukulState();
}

class _ChinnoMukulState extends State<ChinnoMukul> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.chinnoMukulSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
