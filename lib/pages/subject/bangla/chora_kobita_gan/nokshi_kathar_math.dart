...
class NokshiKatharMath extends StatefulWidget {
  const NokshiKatharMath({super.key});

  @override
  State<NokshiKatharMath> createState() => _NokshiKatharMathState();
}

class _NokshiKatharMathState extends State<NokshiKatharMath> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.nokshiKatharMathTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.nokshiKatharMathSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.nokshiKatharMathDesc,
