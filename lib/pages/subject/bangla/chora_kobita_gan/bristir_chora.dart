...
class BristirChora extends StatefulWidget {
  const BristirChora({super.key});

  @override
  State<BristirChora> createState() => _BristirChoraState();
}

class _BristirChoraState extends State<BristirChora> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.bristirChoraTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.bristirChoraSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
