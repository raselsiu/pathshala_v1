...
class EtoHashiKothayPele extends StatefulWidget {
  const EtoHashiKothayPele({super.key});

  @override
  State<EtoHashiKothayPele> createState() => _EtoHashiKothayPeleState();
}

class _EtoHashiKothayPeleState extends State<EtoHashiKothayPele> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.etoHasiKothayPeleTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.etoHasiKothayPeleSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.etoHasiKothayPeleDesc,
