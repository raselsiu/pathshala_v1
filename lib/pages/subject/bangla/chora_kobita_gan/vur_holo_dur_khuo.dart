...
class VurHoloDurKhulo extends StatefulWidget {
  const VurHoloDurKhulo({super.key});

  @override
  State<VurHoloDurKhulo> createState() => _VurHoloDurKhuloState();
}

class _VurHoloDurKhuloState extends State<VurHoloDurKhulo> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.vurHoloDurKhuloTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.vurHoloDurKhuloSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.vurHoloDurKhuloDesc,
