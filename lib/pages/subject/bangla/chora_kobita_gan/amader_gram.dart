...
class AmaderGram extends StatefulWidget {
  const AmaderGram({super.key});

  @override
  State<AmaderGram> createState() => _AmaderGramState();
}

class _AmaderGramState extends State<AmaderGram> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.amaderGramSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
