...
class Songkolpo extends StatefulWidget {
  const Songkolpo({super.key});

  @override
  State<Songkolpo> createState() => _SongkolpoState();
}

class _SongkolpoState extends State<Songkolpo> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.songkolpoSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
