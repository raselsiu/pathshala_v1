...
class AmaderDesh extends StatefulWidget {
  const AmaderDesh({super.key});

  @override
  State<AmaderDesh> createState() => _AmaderDeshState();
}

class _AmaderDeshState extends State<AmaderDesh> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.amaderDeshSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
