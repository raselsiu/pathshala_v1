...
class SuloAnaMiche extends StatefulWidget {
  const SuloAnaMiche({super.key});

  @override
  State<SuloAnaMiche> createState() => _SuloAnaMicheState();
}

class _SuloAnaMicheState extends State<SuloAnaMiche> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.suloAnayMicheTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.suloAnayMicheSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.suloAnayMicheDesc,
