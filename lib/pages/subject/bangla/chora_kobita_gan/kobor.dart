...
class Kobor extends StatefulWidget {
  const Kobor({super.key});

  @override
  State<Kobor> createState() => _KoborState();
}

class _KoborState extends State<Kobor> {
  @override
