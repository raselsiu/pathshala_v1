...
class OneTwoThreeKobita extends StatefulWidget {
  const OneTwoThreeKobita({super.key});

  @override
  State<OneTwoThreeKobita> createState() => _OneTwoThreeKobitaState();
}

class _OneTwoThreeKobitaState extends State<OneTwoThreeKobita> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.oneGeloMachDhorteTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.oneGeloMachDhorteSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.oneGeloMachDhorteDesc,
