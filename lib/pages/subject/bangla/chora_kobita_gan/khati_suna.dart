...
class KhatiSuna extends StatefulWidget {
  const KhatiSuna({super.key});

  @override
  State<KhatiSuna> createState() => _KhatiSunaState();
}

class _KhatiSunaState extends State<KhatiSuna> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.khatiSunaSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
