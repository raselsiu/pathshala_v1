...
class KajlaDidi extends StatefulWidget {
  const KajlaDidi({super.key});

  @override
  State<KajlaDidi> createState() => _KajlaDidiState();
}

class _KajlaDidiState extends State<KajlaDidi> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.kajlaDidiSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
