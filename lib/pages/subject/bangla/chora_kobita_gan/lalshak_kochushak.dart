...
class LalShakKochuShak extends StatefulWidget {
  const LalShakKochuShak({super.key});

  @override
  State<LalShakKochuShak> createState() => _LalShakKochuShakState();
}

class _LalShakKochuShakState extends State<LalShakKochuShak> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.lalShakKochuShakTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.lalShakKochuShakSubTitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.lalShakKochuShakDesc,
