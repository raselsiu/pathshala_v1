...
class MeghnaParerChele extends StatefulWidget {
  const MeghnaParerChele({super.key});

  @override
  State<MeghnaParerChele> createState() => _MeghnaParerCheleState();
}

class _MeghnaParerCheleState extends State<MeghnaParerChele> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.meghnaParerCheleTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.meghnaParerCheleSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.meghnaParerCheleDesc,
