...
class SunarTori extends StatefulWidget {
  const SunarTori({super.key});

  @override
  State<SunarTori> createState() => _SunarToriState();
}

class _SunarToriState extends State<SunarTori> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.sunarToriSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
