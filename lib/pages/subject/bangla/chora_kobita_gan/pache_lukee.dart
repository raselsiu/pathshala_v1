...
class PacheLukee extends StatefulWidget {
  const PacheLukee({super.key});

  @override
  State<PacheLukee> createState() => _PacheLukeeState();
}

class _PacheLukeeState extends State<PacheLukee> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.pacheLukeKichuBoleTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.pacheLukeKichuBoleSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.pacheLukeKichuBoleDesc,
