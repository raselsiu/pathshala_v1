...
class OderJonnoMomota extends StatefulWidget {
  const OderJonnoMomota({super.key});

  @override
  State<OderJonnoMomota> createState() => _OderJonnoMomotaState();
}

class _OderJonnoMomotaState extends State<OderJonnoMomota> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.oderJonnoMomotaTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.oderJonnoMomotaSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.oderJonnoMomotaDesc,
