...
class AmaderChutoNodi extends StatefulWidget {
  const AmaderChutoNodi({super.key});

  @override
  State<AmaderChutoNodi> createState() => _AmaderChutoNodiState();
}

class _AmaderChutoNodiState extends State<AmaderChutoNodi> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.amaderChutoNodiTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.amaderChutoNodiSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.amaderChutoNodiDesc,
