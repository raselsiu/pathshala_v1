...
class NobirSikkha extends StatefulWidget {
  const NobirSikkha({super.key});

  @override
  State<NobirSikkha> createState() => _NobirSikkhaState();
}

class _NobirSikkhaState extends State<NobirSikkha> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.nobirSikkhaSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
