...
class PondoSrom extends StatefulWidget {
  const PondoSrom({super.key});

  @override
  State<PondoSrom> createState() => _PondoSromState();
}

class _PondoSromState extends State<PondoSrom> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.pondoSromSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
