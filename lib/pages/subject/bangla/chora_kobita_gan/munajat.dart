...
class Munajat extends StatefulWidget {
  const Munajat({super.key});

  @override
  State<Munajat> createState() => _MunajatState();
}

class _MunajatState extends State<Munajat> {
  @override
