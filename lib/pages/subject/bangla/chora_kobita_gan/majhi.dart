...
class Majhi extends StatefulWidget {
  const Majhi({super.key});

  @override
  State<Majhi> createState() => _MajhiState();
}

class _MajhiState extends State<Majhi> {
  @override
