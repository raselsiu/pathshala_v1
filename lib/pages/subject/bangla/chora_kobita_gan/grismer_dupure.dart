...
class GrismerDupure extends StatefulWidget {
  const GrismerDupure({super.key});

  @override
  State<GrismerDupure> createState() => _GrismerDupureState();
}

class _GrismerDupureState extends State<GrismerDupure> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.grismerDupureTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.grismerDupureSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.grismerDupureDesc,
