...
class TalGach extends StatefulWidget {
  const TalGach({super.key});

  @override
  State<TalGach> createState() => _TalGachState();
}

class _TalGachState extends State<TalGach> {
  @override
