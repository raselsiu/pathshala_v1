...
class SobarAmiChatro extends StatefulWidget {
  const SobarAmiChatro({super.key});

  @override
  State<SobarAmiChatro> createState() => _SobarAmiChatroState();
}

class _SobarAmiChatroState extends State<SobarAmiChatro> {
  @override
  Widget build(BuildContext context) {
    return AdScaffold(
      appBar: AppBar(
        ...
        title: const Text(
          PoemConstant.sobarAmiChatroTitle,
          style: TextStyle(
            color: Colors.white,
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.sobarAmiChatroSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
                  ...
                  const Text(
                    PoemConstant.sobarAmiChatroDesc,
