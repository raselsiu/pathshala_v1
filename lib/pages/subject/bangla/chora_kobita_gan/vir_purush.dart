...
class VirPurush extends StatefulWidget {
  const VirPurush({super.key});

  @override
  State<VirPurush> createState() => _VirPurushState();
}

class _VirPurushState extends State<VirPurush> {
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(
                    child: Text(
                      PoemConstant.birPurushSubtitle,
                      style: TextStyle(
                        fontFamily: StringConstants.samirFont,
                        fontSize: 16,
                      ),
